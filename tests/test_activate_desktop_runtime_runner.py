...
def test_contract_is_repo_runner_and_labels_pinned() -> None:
    ...
    assert 'RUNNER_LABELS = "pc24x7,desktop-runtime"' in text
...
def test_runtime_active_requires_registry_online_and_labels() -> None:
    ...
    assert 'REQUIRED_RUNNER_LABELS = ("self-hosted", "Windows", "X64", "pc24x7", "desktop-runtime")' in text
